...
type InvoiceServiceClient interface {
	GetInvoice(ctx context.Context, in *InvoiceRequest, opts ...grpc.CallOption) (*Invoice, error)
}
...
func (c *invoiceServiceClient) GetInvoice(ctx context.Context, in *InvoiceRequest, opts ...grpc.CallOption) (*Invoice, error) {
...
type InvoiceServiceServer interface {
	GetInvoice(context.Context, *InvoiceRequest) (*Invoice, error)
...
func (UnimplementedInvoiceServiceServer) GetInvoice(context.Context, *InvoiceRequest) (*Invoice, error) {
...
func _InvoiceService_GetInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InvoiceServiceServer).GetInvoice(ctx, req.(*InvoiceRequest))
	}
