...
const file_subscription_proto_rawDesc = "" +
	"\n" +
	"\x12subscription.proto\x12\fsubscription\"T\n" +
	...
	"\x0fGetSubscription\x12!.subscription.SubscriptionRequest\x1a\x1a.subscription.SubscriptionB\x14Z\x12proto/subscriptionb\x06proto3"
...
var file_subscription_proto_goTypes = []any{
	...
	(*SubscriptionRequest)(nil), // 1: subscription.SubscriptionRequest
}
var file_subscription_proto_depIdxs = []int32{
	1, // 0: subscription.SubscriptionService.GetSubscription:input_type -> subscription.SubscriptionRequest
	0, // 1: subscription.SubscriptionService.GetSubscription:output_type -> subscription.Subscription
