...
type NotificationServiceClient interface {
	GetNotification(ctx context.Context, in *NotificationRequest, opts ...grpc.CallOption) (*Notification, error)
}
...
func (c *notificationServiceClient) GetNotification(ctx context.Context, in *NotificationRequest, opts ...grpc.CallOption) (*Notification, error) {
...
type NotificationServiceServer interface {
	GetNotification(context.Context, *NotificationRequest) (*Notification, error)
...
func (UnimplementedNotificationServiceServer) GetNotification(context.Context, *NotificationRequest) (*Notification, error) {
