...
const file_review_proto_rawDesc = "" +
	...
	"\rReviewService\x122\n" +
	"\tGetReview\x12\x15.review.ReviewRequest\x1a\x0e.review.ReviewB\x0eZ\fproto/reviewb\x06proto3"
...
var file_review_proto_depIdxs = []int32{
	1, // 0: review.ReviewService.GetReview:input_type -> review.ReviewRequest
	0, // 1: review.ReviewService.GetReview:output_type -> review.Review
